...
#' data(tinyTree)
#'
#' ct <- matrix(rpois(n = 28, lambda = 10), ncol = 4)
#' colnames(ct) <- paste("S", 1:4, sep = "")
...
#'
#' col_split <- c("S1" = "C", "S2" = "B", "S3" = "A", "S4" = "A")
#' col_anno <- c("S1" = "C", "S2" = "C", "S3" = "D", "S4" = "D")
#' col_order <- rev(colnames(hm_data))
#'
#'
...
#'                    column_anno_size = 1,
#'                    column_anno_gap = 0.8,
#'                    column_anno_color = c("C" = "red", "D" = "blue"),
#'                    column_order = col_order,
#'                    column_split = col_split,
#'                    show_colnames = TRUE,
#'                    show_rownames = TRUE,
#'                    rownames_offset_x = 0.1, rownames_hjust = 0)
#' fig
#' # use expand_limits to display the missing part of row names
#' fig + expand_limits(x = c(0, 15))
#'
